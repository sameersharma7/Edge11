...
import { createUserProfile } from '../../lib/supabaseClient';
...
export default function RoleSelectPage() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-white flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          <div className="w-20 h-20 bg-linear-to-br from-emerald-400 to-cyan-500 rounded-lg flex items-center justify-center font-bold text-4xl text-slate-900 shadow-lg shadow-emerald-500/50 mx-auto mb-6">
            E
          </div>
        ...
        <div className="mb-8 max-w-md mx-auto">
          ...
          <p className="text-xs text-slate-500 mt-2">
            This will be your public username on EDGE11
          </p>
        </div>
          ...
          <div
            ...
            className={`relative rounded-2xl overflow-hidden border-2 transition cursor-pointer transform hover:scale-105 ${
              selectedRole === 'expert'
                ...
                : 'border-emerald-500/30 bg-linear-to-br from-slate-700/50 to-slate-800/50 hover:border-emerald-400/60'
          ...
          <div
            ...
            className={`relative rounded-2xl overflow-hidden border-2 transition cursor-pointer transform hover:scale-105 ${
              selectedRole === 'bettor'
                ...
                : 'border-cyan-500/30 bg-linear-to-br from-slate-700/50 to-slate-800/50 hover:border-cyan-400/60'
            } backdrop-blur-xl p-8`}
          >
